...
def generate_info_card():
    ...
    <g id="card-line-{idx}">
      ...
      <animateTransform attributeName="transform" type="translate" values="0 6; 0 0" dur="0.5s" begin="{delay:.2f}s" fill="freeze" />
    ...
    <g id="card-line-status">
      <animate attributeName="opacity" values="0;1" dur="0.5s" begin="{status_delay:.2f}s" fill="freeze" />
      <animateTransform attributeName="transform" type="translate" values="0 6; 0 0" dur="0.5s" begin="{status_delay:.2f}s" fill="freeze" />
